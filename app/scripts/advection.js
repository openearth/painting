...
var fragmentSource = [
    ...
    '  // locations',
    '  vec2 me = vec2(vTextureCoord.x, vTextureCoord.y);',
    '  vec2 left = vec2(me.x - onePixel.x, me.y);',
    '  vec2 right = vec2(me.x + onePixel.x, me.y);',
    '  vec2 top = vec2(me.x, me.y - onePixel.y);',
    '  vec2 bottom = vec2(me.x, me.y + onePixel.y);',
    ...
    '  float fade = 1.0;',
    '  vec4 uMe = texture2D(mapSampler, me);',
